...
class JPushController extends GetxController {
  ...
  //   jPush.getLaunchAppNotification().then((message) async {
  //     print("jpush flutter getLaunchAppNotification success:$message");
  //   }).catchError((error) {
  ...
  // this.uid = uid;
  // var logged = DataPersistence.getPushLoginStatus(uid);
  // if (logged != true) {
  //   await jPush.setAlias(uid).then((map) async {
  //     print("jpush setAlias success: $map");
  //     await DataPersistence.putPushLoginStatus(uid);
  //   }).catchError((error) {
  //     print("jpush setAlias error: $error");
  //   });
  // }
  ...
  //   print("jpush deleteAlias success: $map");
  //   await DataPersistence.removePushLoginStatus(uid);
  // }).catchError((error) {
  //   print("jpush deleteAlias error: $error");
  // });
  // return true;
