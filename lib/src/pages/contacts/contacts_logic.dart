...
class ContactsLogic extends GetxController {
  ...
  var myDeptList = <UserInDept>[].obs;

  // final deptName = Config.deptName;
  // final deptID = Config.deptID;
  ...
  void viewOrganization(DeptInfo? deptInfo) {
    AppNavigator.startOrganization(deptInfo: deptInfo);
  }
