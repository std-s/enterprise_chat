          ...
          child: Column(
            children: [
              ...
              _buildItemView(
                ...
                value: imLogic.userInfo.value.birthTime!.split('T').first,
                onTap: () => logic.openDatePicker(),
              ),
              if (imLogic.userInfo.value.phoneNumber != null &&
              ...
              if (imLogic.userInfo.value.email != null && imLogic.userInfo.value.email!.isNotEmpty)
                _buildItemView(
                  label: StrRes.email,
