    ...
    return Obx(
      () => Scaffold(
        appBar: EnterpriseTitleBar.back(
          title: '${StrRes.groupMember}（${logic.groupInfo.memberCount}）',
          actions: [
            PopButton(
            ...
            Expanded(
              child: SmartRefresher(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (_, index) {
                    final data = logic.allList.elementAt(index);
                    return Obx(() => buildAzListItemView(
                          name: data.nickname!,
                          url: data.faceURL,
                          onTap: () => logic.viewUserInfo(data),
                          onlineStatus: logic.onlineStatus[data.userID],
                          tags: [
                            if (data.roleLevel != GroupRoleLevel.member)
